...
@Entity
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED) // JPA는 기본 생성자 있어야 하나, 표시하고 싶지 않을 때 @NoArgsConstructor 사용. 단, JPA스펙 상(생성자에 privcate을 허용하지 않으므로) PROTECTED로 열어두는 것.
